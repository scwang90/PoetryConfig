...
import com.poetry.model.JokeConfig;
...
public class JokeConfigDao extends XmDao<Config> implements IDao<Config> {

	private String key = AfMD5.getMD5("");
	private DesUtils des = new DesUtils(key);
	
	public JokeConfigDao(GalaxyAdmin galaxy) {
		// TODO Auto-generated constructor stub
		super(JokeConfig.class, galaxy);
	}
...
//		get.withAttributes(values);
	...
	protected Config doItemFromRecord(Record record) {
		// TODO Auto-generated method stub
		String json = record.getAttributes().get("Value").getValue();
		json = des.decryptNoException(json);
		JokeConfig item = new Gson().fromJson(json, JokeConfig.class);
